...
public class Registration extends AppCompatActivity {
    ...
    private Button singIn = findViewById(R.id.SingIn);
    private EditText userName = findViewById(R.id.UserName);
    private EditText mEmail = findViewById(R.id.Email);
    private EditText mPassword = findViewById(R.id.Password);
    private EditText mConfirmPassword = findViewById(R.id.Confirm_Password);
